...
export const Navbar = ({ setMenuOpen }) => {
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 w-[98%] sm:w-[95%] md:w-[90%] lg:w-[85%] z-50
      bg-[rgba(255,255,255,0.08)] backdrop-blur-md border border-white/10 shadow-xl rounded-xl px-6 py-2">
